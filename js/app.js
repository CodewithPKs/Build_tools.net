...
const barsContainer = document.getElementById('scrollable-bars');

barsContainer.addEventListener('mouseover', () => {
    barsContainer.style.overflowY = 'scroll';
    barsContainer.style.height = '100px'; // Set your desired height here
});

barsContainer.addEventListener('mouseout', () => {
    barsContainer.style.overflowY = 'hidden';
    barsContainer.style.height = '16.5px'; // Set the original height here
});
